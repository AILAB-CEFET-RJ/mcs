...
::python src\train_model.py -t %TASK% -l %LEARNER% -p "6870066"
::python src\train_model.py -t %TASK% -l %LEARNER% -p "6042619"
::python src\train_model.py -t %TASK% -l %LEARNER% -p "2288893"
::python src\train_model.py -t %TASK% -l %LEARNER% -p "5106702"
::python src\train_model.py -t %TASK% -l %LEARNER% -p "6635148"
::python src\train_model.py -t %TASK% -l %LEARNER% -p "2269481"
::python src\train_model.py -t %TASK% -l %LEARNER% -p "2708353"
::python src\train_model.py -t %TASK% -l %LEARNER% -p "7591136"
::python src\train_model.py -t %TASK% -l %LEARNER% -p "2283395"
::python src\train_model.py -t %TASK% -l %LEARNER% -p "2287579"
::python src\train_model.py -t %TASK% -l %LEARNER% -p "2291533"
::python src\train_model.py -t %TASK% -l %LEARNER% -p "2292386"
::python src\train_model.py -t %TASK% -l %LEARNER% -p "0012505"
::python src\train_model.py -t %TASK% -l %LEARNER% -p "2292084"
::python src\train_model.py -t %TASK% -l %LEARNER% -p "6518893"
